...
const Boxes = ({ highlight }: { highlight?: boolean }) => {
    return (
        <div className={`rounded-full shrink-0 inline-block size-[3px] ${highlight ? 'bg-white animate-pulse ease-linear duration-300' : 'bg-white/30'}`}></div>
    )
}
